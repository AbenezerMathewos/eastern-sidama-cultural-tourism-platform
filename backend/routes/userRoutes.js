...
// Admin guide assignment routes
router.patch('/hosts/:hostId/assign-guide', userController.assignGuideToHost);
router.patch('/hosts/:hostId/reassign-guide', userController.reassignGuideToHost);
