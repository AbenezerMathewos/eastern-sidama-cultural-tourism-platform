...
import { API_ORIGIN, guideApplicationAPI } from "@/lib/api";
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {selectedApplication.media?.nationalIdFront && (
                      <div>
                        ...
                        <img
                          src={resolveMediaUrl(selectedApplication.media.nationalIdFront)}
                          alt="National ID Front"
                          className="w-full h-48 object-cover rounded-lg border cursor-pointer hover:opacity-80 transition-opacity"
                          onClick={() => setFullscreenImage(resolveMediaUrl(selectedApplication.media.nationalIdFront))}
                        />
                      </div>
                    )}
                    ...
                    {selectedApplication.media?.nationalIdBack && (
                      <div>
                        ...
                        <img
                          src={resolveMediaUrl(selectedApplication.media.nationalIdBack)}
                          alt="National ID Back"
                          className="w-full h-48 object-cover rounded-lg border cursor-pointer hover:opacity-80 transition-opacity"
                          onClick={() => setFullscreenImage(resolveMediaUrl(selectedApplication.media.nationalIdBack))}
                        />
                      </div>
                    )}
                  </div>
                  ...
                  {selectedApplication.media?.personalPhoto && (
                    <div>
                      ...
                      <img
                        src={resolveMediaUrl(selectedApplication.media.personalPhoto)}
                        alt="Personal"
                        className="w-48 h-48 object-cover rounded-lg border cursor-pointer hover:opacity-80 transition-opacity"
                        onClick={() => setFullscreenImage(resolveMediaUrl(selectedApplication.media.personalPhoto))}
                      />
                    </div>
                  )}
                    ...
                    <div>
                      ...
                      {selectedApplication.media.tourGuideCertificate.endsWith('.pdf') || selectedApplication.media.tourGuideCertificate.includes('pdf') ? (
                        <div className="p-4 border rounded-lg bg-gray-50">
                          <a
                            href={resolveMediaUrl(selectedApplication.media.tourGuideCertificate)}
                            target="_blank"
                        ...
                        <img
                          src={resolveMediaUrl(selectedApplication.media.tourGuideCertificate)}
                          ...
                          onClick={() => setFullscreenImage(resolveMediaUrl(selectedApplication.media.tourGuideCertificate))}
                        />
                      )}
                    </div>
                  )}
