...
import { AlertCircle, ArrowLeft, Banknote, CheckCircle, Clock, DollarSign, Loader2, Wallet as WalletIcon } from "lucide-react";
...
export default function Wallet() {
  ...
  // --- UPDATED DATA ACCESS LOGIC ---
  // We now use the virtual ETB fields we created in the backend
  const available = parseFloat(data?.data?.availableBalance || "0");
  const pending = parseFloat(data?.data?.pendingPayout || "0");
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-3">
                    ...
                    />
                    <Button
                      disabled={createMutation.isPending || !canRequest}
